                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('update_category') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="category_name" type="text" class="form-control @error('category_name') is-invalid @enderror" name="category_name" value="{{ $data['category_name'] }}" required autocomplete="email">
